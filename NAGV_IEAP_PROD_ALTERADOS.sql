CREATE OR REPLACE VIEW CONSINCO.NAGV_IEAP_PROD_ALTERADOS AS
SELECT P.DESCCOMPLETA NAME,
 ...
 WHERE 1=1 -- P.INDINTEGRAECOMMERCE = 'S'
   AND GREATEST(/*NVL(P.DTAHORINCLUSAO,    SYSDATE - 7),*/
                NVL(P.DTAHORALTERACAO,   SYSDATE - 7),
                NVL(F.DTAHORALTERACAO,   SYSDATE - 7),
                NVL(C.DATAHORAALTERACAO, SYSDATE - 7)) >= TRUNC(SYSDATE)
